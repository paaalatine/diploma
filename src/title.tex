...

{
  ...
  \titledline{Консультант(ы):} \\[-1em]
  а)\hspace{-5pt}$\underset{\text{\scriptsize (Фамилия, И., О.,  ученое звание, степень)}}{\underline{\makebox[\remaining][s]{\strut}}}$\hfill\signature \\[0.25em]\\[-1em]
 б)\hspace{-5pt}$\underset{\text{\scriptsize (Фамилия, И., О.,  ученое звание, степень)}}{\underline{\makebox[\remaining][s]{\strut}}}$\hfill\signature \\[0.25em]\\[-1em]
 \

  ВКР принята \datetemplate \\[-1em]

  Оригинальность ВКР $\underline{\makebox[7em][s]{\strut}{\strut\hfill 85 \hfill}}$\,\% \\[-1em]
  ...
  \hspace{-5pt}$\underset{\text{\scriptsize (ФИО)}}{\underline{\makebox[\remaining][s]{\strut}}}$
  \hfill\signature \\[0.25em]
